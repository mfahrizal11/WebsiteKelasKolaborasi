  ...
  <div class="mb-3">
    ...
    <form method="POST" action="/dashboard/posts/{{$post->id}}" class="mb-5">
      ...
      <div class="mb-3">
        ...
        <input class="form-control @error('image') is-invalid @enderror" type="file" id="image" multiple name="image">
        @error('image')
        <div class="invalid-feedback">
          {{$message}}
        @enderror
      ...
      <div class="mb-3">
        ...
        @enderror
        <input id="body" type="hidden" name="body" required autofocus value="{{old('body',  $post->body)}}">
